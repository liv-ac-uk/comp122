...
### Walkthrough
This exercise is based on a lab used in [Harvard's CS50 course](https://cs50.harvard.edu/x/2020/psets/1/credit/) for learning C. The following may help you. Ignore everything related to user input (that's already done for you here).
